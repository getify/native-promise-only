...
describe("ES6 25.4.4.3 Promise.race( iterable )", function () {
	...
	it("should immediately reject for non-iterable argument", function (done) {
		Promise.race({}).then(unexpectedResolve, function (err) {
	...
	describe("additional spec requirements", function () {
		it("requires 'this' to be a Promise constructor", function (done) {
			var empty = {};
